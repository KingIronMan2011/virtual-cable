          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("button", {
                ...
                onClick: onClose,
                children: _jsx(X, { size: 15, strokeWidth: 2 }),
              }),
            ],
          }),
          _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("span", {
                            className: "settings-row-val",
                            children: "Tauri \u00B7 React \u00B7 PortAudio",
                          }),
                        ],
                      }),
                    ],
              ...
              _jsxs("section", {
                ...
                children: [
                  ...
                  settings.experimentalFeatures &&
                    _jsxs("div", {
                      className: "experimental-features",
                      children: [
                        _jsxs("div", {
                          ...
                          children: [
                            _jsxs("div", {
                              className:
                                "settings-toggle-row exp-feature-toggle",
                              children: [
                                _jsxs("div", {
                                  className: "settings-toggle-text",
                                  children: [
                                    _jsx("span", {
                                      className: "settings-toggle-label",
                                      children: "Custom latency",
                                    }),
                                    _jsx("span", {
                                      className: "settings-toggle-sub",
                                      children:
                                        "Override PortAudio buffer size. Active cables restart when changed.",
                                    }),
                                  ],
                                }),
                                _jsxs("label", {
                            ...
                            settings.expLatency &&
                              _jsx("div", {
                                className: "latency-picker",
                                children: BUFFER_OPTIONS.map((opt) =>
                                  _jsxs(
                                    "button",
                                    {
                                      className: `latency-btn${settings.bufferSize === opt.value ? " is-active" : ""}`,
                                      onClick: () =>
                                        setSetting({ bufferSize: opt.value }),
                                      children: [
                                        _jsx("span", {
                                          className: "latency-btn-label",
                                          children: opt.label,
                                        }),
                                        _jsx("span", {
                                          className: "latency-btn-sub",
                                          children: opt.sub,
                                        }),
                                      ],
                                    },
                        ...
                        _jsx("div", {
                          className: "exp-feature",
                          children: _jsxs("div", {
                            className: "settings-toggle-row exp-feature-toggle",
                            children: [
                              _jsxs("div", {
                                className: "settings-toggle-text",
                                children: [
                              ...
                              _jsxs("label", {
                                ...
                                children: [
                                  _jsx("input", {
                                    ...
                                    onChange: (e) =>
                                      setSetting({
                                        expSampleRate: e.target.checked,
                                      }),
                                  }),
                                  _jsx("span", { className: "toggle-slider" }),
                                ],
              ...
              _jsxs("section", {
                ...
                children: [
                      ...
                      updateState.status === "ready" &&
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsx("span", {
                              className: "settings-row-val update-version",
                  ...
                  updateState.status === "error" &&
                    updateState.error &&
                    _jsx("p", {
                      className: "update-error-msg",
                      children: updateState.error,
                    }),
                  _jsx("div", {
