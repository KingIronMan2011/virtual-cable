...
export const tauriAPI = {
    ...
    createTunnel: (id, inputs, outputId, channelCount, ducking) => invoke("create_tunnel", {
        id,
        inputs,
        outputId,
        channelCount,
    ...
    setTunnelInputGain: (id, inputIndex, gain) => invoke("set_tunnel_input_gain", { id, inputIndex, gain }),
    setTunnelInputPriority: (id, inputIndex, priority) => invoke("set_tunnel_input_priority", { id, inputIndex, priority }),
    setTunnelDucking: (id, ducking) => invoke("set_tunnel_ducking", { id, ...ducking }),
    onAudioLevel: (cb) => {
