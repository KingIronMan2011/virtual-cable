...
// virtual-cable-engine and electron must be external: they are native/built-in
// and cannot be bundled by Rollup.
export default defineConfig({
  build: {
    rollupOptions: {
      external: ["electron", "virtual-cable-engine"],
      output: {
        ...
        // Adding that path to module.paths lets require('virtual-cable-engine')
        // resolve there, along with its portaudio_x64.dll dependency.
